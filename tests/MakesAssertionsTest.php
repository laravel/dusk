...
class MakesAssertionsTest extends TestCase
{
    ...
    public function test_assert_see()
    {
        ...
        $resolver->shouldReceive('findOrFail->getText')->andReturn(
            'foo'
        );
    ...
    public function test_assert_input_value()
    {
        ...
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForTyping')->andReturn($element);
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_input_value_is_not()
    {
        $driver = Mockery::mock(StdClass::class);
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForTyping->getTagName')->andReturn('input');
        $resolver->shouldReceive('resolveForTyping->getAttribute')->andReturn(
            'value'
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_input_value()
    {
        ...
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForTyping')->with('foo')->andReturn($element);
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_checked()
    {
        $driver = Mockery::mock(StdClass::class);
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForChecking->isSelected')->andReturn(
            true,
            false
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_radio_selected()
    {
        $driver = Mockery::mock(StdClass::class);
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForRadioSelection->isSelected')->andReturn(
            true,
            false
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_selected()
    {
        $driver = Mockery::mock(StdClass::class);
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForSelection->getAttribute')->andReturn(
            'bar'
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_select_has_options()
    {
        ...
        $resolver->shouldReceive('resolveSelectOptions')->andReturn(
            [$option, $option]
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_selected()
    {
        $driver = Mockery::mock(StdClass::class);
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('resolveForSelection->getAttribute')->with('value')->andReturn(
            'bar'
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_value()
    {
        $driver = Mockery::mock(StdClass::class);
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('findOrFail->getAttribute')->with('value')->andReturn(
            'bar'
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_visible()
    {
        ...
        $resolver->shouldReceive('findOrFail->isDisplayed')->andReturn(
            true,
            false
        );
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_missing()
    {
        ...
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('format')->with('foo')->andReturn('body foo');
        $resolver->shouldReceive('findOrFail')->once()->with('foo')->andThrow(NoSuchElementException::class);
        $resolver->shouldReceive('findOrFail')->andReturn($element);
        $browser = new Browser($driver, $resolver);
    ...
    public function test_assert_vue()
    {
        ...
        $resolver = Mockery::mock(StdClass::class);
        $resolver->shouldReceive('format')->with('baz')->andReturn('body baz');
        $browser = new Browser($driver, $resolver);
